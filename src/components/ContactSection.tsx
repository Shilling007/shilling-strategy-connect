              ...
              <div className="space-y-6">
                ...
                <div className="pt-6">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://www.instagram.com/shilling_official?igsh=a3ZrdnoxYzBya2Vu" target="_blank" rel="noopener noreferrer" className="bg-[#E1306C] text-white p-2 rounded-full hover:bg-[#E1306C]/80 transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
