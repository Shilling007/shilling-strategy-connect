  ...
  return (
    <section id="contact" className="section-padding bg-white">
      <div className="container mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">keerthivasan@shillingstrategyconsulting.com</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    id="service"
                    name="service"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-navy focus:border-navy"
        ...
        <div className="mt-16">
          <h3 className="text-xl font-semibold text-navy mb-6 text-center">Our Location</h3>
          <div className="rounded-lg overflow-hidden h-80 shadow-md">
            {/* This is a placeholder for the Google Maps embed */}
            <div className="w-full h-full bg-gray-100 flex items-center justify-center">
              <p className="text-gray-500">Google Map will be embedded here</p>
              {/* In a real scenario, you would replace this with an actual Google Maps iframe */}
            </div>
          </div>
        </div>
      </div>
