          ...
          <div className="order-2 md:order-1">
            <div className="animate-fade-up">
              <div className="flex items-center mb-4">
                <BookOpen className="text-navy mr-2" size={20} />
                <h2 className="text-2xl sm:text-3xl font-bold text-navy">About Us</h2>
              </div>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-navy mb-3">Our Mission</h3>
              <p className="text-sm sm:text-base text-gray-700 mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-navy mb-3">Our Vision</h3>
              ...
              <div className="bg-lightblue p-4 sm:p-5 rounded-lg border border-navy/10">
                <h4 className="text-base sm:text-lg font-semibold text-navy mb-2">What Makes Us Different</h4>
